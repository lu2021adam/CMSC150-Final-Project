...
public class BRUCEA_FINALPROJECT{
    ...
    public static void battleTutorial(){
        ...
        System.out.println("Good luck, restart the game now to play!");
    }
...
//    }
    ...
    if(lowerTutorial.equals("yes")){
        ...
        if(lowerPokemonChoice.equals("bulbasaur") || lowerPokemonChoice.equals("charmander") || lowerPokemonChoice.equals("squirtle")){
                ...
                // In the future, I will go to the next gym if the user wins, and end if they lose, instead of just printing the battle result.
        } else {
            System.out.println("Please enter a valid pokemon or spell the Pokemons name correctly to play. (Case Sensitive)");
        }
    } else {
        System.out.println("Please enter either yes or no to play the game.");
    }
    }
}
